...
class Task(models.Model):
    ...
    coexecutors = models.JSONField(default=list, blank=True)
    ...
    planner_at = models.DateTimeField(null=True, blank=True)
    reminder_enabled = models.BooleanField(default=False)
    reminder_before = models.CharField(max_length=64, blank=True)
    reminder_channel = models.CharField(max_length=128, blank=True)
