...
function buildRemainingWork() {
  ...
  // Актуалізовано 20.07.2026: AI на реальному Claude, auth на проді та щоденні
  // бекапи БД — вже зроблено (прибрано зі списку).
  // tag: "потрібні доступи"/"ключ + рішення"/"рішення клієнта" — залежить від клієнта;
  //      "код" — наша розробка; "перевірка"/"док" — організаційне.
  return [
    { area: "Інтеграції", title: "Бойова відправка Telegram / SMS / Email", note: "Зараз демо/mock-провайдер. Потрібні токен бота Telegram, ключ SMS-шлюзу та SMTP-доступи пошти бюро (п.19 ТЗ) + тестова відправка.", tag: "потрібні доступи", tone: "red" },
    { area: "AI", title: "Власний ключ Anthropic + баланс", note: "AI-помічник і AI-перевірка документів працюють на реальному Claude, але на тестовому ключі розробки. Бюро реєструє власний акаунт на console.anthropic.com і поповнює баланс (оплата за запит).", tag: "ключ + рішення", tone: "red" },
    { area: "Інтеграції", title: "КЕП (е-підпис) — реальне підписання", note: "UI і статуси готові, працює демо-підпис. Для реального накладання КЕП потрібна інтеграція із сервісом підпису (рішення + доступи клієнта).", tag: "потрібні доступи", tone: "red" },
    { area: "Документообіг", title: "Рішення по п.17 ТЗ", note: "Підтвердити, чи прибирати справи з розділу повністю (чистий standalone), чи лишити зведений реєстр документів для зручного відкриття.", tag: "рішення клієнта", tone: "amber" },
    { area: "Документи", title: "Реальні DOCX/PDF клієнта в ONLYOFFICE", note: "ONLYOFFICE self-hosted на сервері. Лишилось перевірити відкриття/редагування на кількох справжніх файлах бюро.", tag: "перевірка", tone: "amber" },
    { area: "Пілот", title: "Фінальний рольовий UI-прогін", note: "Backend-розмежування прав перевірено (адвокат бачить лише свої справи). Лишився короткий прогін інтерфейсу під помічником і бухгалтером.", tag: "перевірка", tone: "amber" },
    { area: "Пілот", title: "Коротка інструкція для замовника", note: "1-2 сторінки: як вести клієнта, справу, документи й фінанси, як користуватись AI-помічником.", tag: "док", tone: "amber" },
    { area: "Безпека", title: "Валідація значень полів (choices/типи)", note: "Битий JSON вже → 400. Лишилась акуратна перевірка допустимих значень у backend upsert.", tag: "код", tone: "blue" },
